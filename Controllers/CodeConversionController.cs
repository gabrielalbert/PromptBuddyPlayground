...
namespace ConversionServer.Controllers
{
    ...
    public class CodeConversionController : ControllerBase
    {
        ...
        {
            return new List<ConversionInstanceModel>();
        ...
        {
            return new List<ConversionLogModel>();
        ...
        {
            var fileEntryCollection = new List<FileEntryModel>();// await ApplicationDBContext.GetFileEntries(fileCollectionId);
